...
public String tgl_lahir;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PROFIL NASABAH");
...
cari.requestFocus();
    ...
    private void tb_hapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tb_hapusActionPerformed
        ...
        if (confirm == 0) {
            try {
                java.sql.Connection conn=(java.sql.Connection)projek.Koneksi.koneksiDB();
                java.sql.PreparedStatement pst = conn.prepareStatement("delete from tbdata where no='"+no.getText()+"' ");
                pst.executeUpdate();
    ...
    private void tb_cetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tb_cetakActionPerformed
         ...
         try {
        JasperPrint jp;
             jp = JasperFillManager.fillReport(getClass().getResourceAsStream("/projek/laporan.jasper"), null, Koneksi.koneksiDB());
